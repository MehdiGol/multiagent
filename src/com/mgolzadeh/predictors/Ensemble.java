...
public class Ensemble implements Serializable
{
	...
	public void train(ArrayList<Example> mylist, int howManyIterations)
	{
	 ...
	 * 
	 */
	public double test(ArrayList<Example> mylist)
	{
	...
	protected double mse(ArrayList<Example> mylist)
	{
	...
	protected double errorRate(ArrayList<Example> mylist)
	{
		int errors=0;
